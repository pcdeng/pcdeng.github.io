...
import { DATABASES_COLUMNS_CONF as allConfigs } from './confs/databases-columns-conf';

generateScQueryInterface('CompareBys', allConfigs);
generateScQuery();
...
function generateScQuery() {
  http
    ...
    .then((r) => {
      ...
      for (const technology in properties) {
        o[technology] = {};
